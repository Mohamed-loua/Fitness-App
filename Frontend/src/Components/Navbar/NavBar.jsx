...
const NavBar = ({ isOpen, isAuthenticated, handleLogout }) => {
  ...
  return (
   ...
   <Navbar
          ...
          variant='light'
        >
           <Nav.Item className="font-bold-extra text-uppercase logo-text" onClick={reloadIfOnSamePage}> My Fitness App</Nav.Item>
          <Navbar.Brand ><img onClick={reloadIfOnSamePage} src={Logo} className='Logo'></img>
         
          </Navbar.Brand>
          <Navbar.Toggle className='deadpool'  aria-controls="responsive-navbar-nav" />
            ...
            <Nav>
              <Nav.Link eventKey={2} href="#memes">
                ...
                <NavDropdown.Item onClick={() => navigate('/login')} className='nav-link-transition'>Login</NavDropdown.Item>
                  ...
                  <NavDropdown.Divider />
                  <NavDropdown.Item href="TBA">Settings</NavDropdown.Item>
